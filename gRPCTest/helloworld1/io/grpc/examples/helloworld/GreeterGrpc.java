...
public final class GreeterGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.grpc.examples.helloworld.ByeRequest,
      io.grpc.examples.helloworld.ByeReply> METHOD_SAY_BYE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "helloworld.Greeter", "SayBye"),
          io.grpc.protobuf.ProtoUtils.marshaller(io.grpc.examples.helloworld.ByeRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(io.grpc.examples.helloworld.ByeReply.getDefaultInstance()));
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayBye(io.grpc.examples.helloworld.ByeRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.ByeReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.examples.helloworld.ByeRequest,
                io.grpc.examples.helloworld.ByeReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
    ...
    /**
     */
    public io.grpc.examples.helloworld.ByeReply sayBye(io.grpc.examples.helloworld.ByeRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.helloworld.ByeReply> sayBye(
        io.grpc.examples.helloworld.ByeRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAY_BYE:
          serviceImpl.sayBye((io.grpc.examples.helloworld.ByeRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.ByeReply>) responseObserver);
          break;
        default:
